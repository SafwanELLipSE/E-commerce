        ...
        <div class="card card-solid">
            ...
            <div class="row">
                ...
                <div class="col-12 product-image-thumbs">
                    <div class="product-image-thumb active"><img src="/product_image/{{$product->image}}" alt="Product Image"></div>
                    @foreach ($arryImage as $image)
                        <div class="product-image-thumb" ><img src="/product_image/{{$image}}" alt="Product Image"></div>
                    @endforeach
                </div>
                </div>
                <div class="col-12 col-sm-6">
                ...
                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                    @foreach ($arrayColor as $color)
                        <label class="btn btn-default text-center active">
                            ...
                            {{ App\Models\Product::getColor($color)->name }}
                            <br>
                        <i class="fas fa-circle fa-2x" style="color:{{ App\Models\Product::getColor($color)->code }} !important;"></i>
                    </label>
                    @endforeach
                </div>
                ...
                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                    @foreach ($arrayFeature as $feature)
                        <label class="btn btn-default text-center">
                            ...
                            <span class="text-xl">{{ App\Models\Product::getFeature($feature)->name }}</span>
                            <br>
                        </label>
                    @endforeach
                </div>
